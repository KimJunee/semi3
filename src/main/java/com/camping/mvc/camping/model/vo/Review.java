...
public class Review {
	...
	public String toString() {
		return "Review [rev_no=" + rev_no + ", rev_title=" + rev_title + ", rev_content=" + rev_content
				+ ", rev_regist=" + rev_regist + ", rev_image=" + rev_image + ", rev_image_rename" 
				+ rev_image_rename + ", rev_star=" + rev_star + ", user_id="
	...
	public String getRev_image_rename() {
		return rev_image_rename;
	}
