...
public class CampingVO {
	...
	public CampingVO(int cs_no, int rowNum, String cs_name, String cs_line_intro, String cs_intro, String cs_allar,
	...
	public String toString() {
		return "CampingVO [cs_no=" + cs_no + ", rowNum=" + rowNum + ", cs_name=" + cs_name + ", cs_line_intro="
				+ cs_line_intro + ", cs_intro=" + cs_intro + ", cs_allar=" + cs_allar + ", cs_insrnc_at=" + cs_insrnc_at
				+ ", cs_bizr_no=" + cs_bizr_no + ", cs_managesttus=" + cs_managesttus + ", cs_feature_name="
				+ cs_feature_name + ", cs_induty=" + cs_induty + ", cs_lct_cl=" + cs_lct_cl + ", cs_do_name="
				+ cs_do_name + ", cs_sigungu_name=" + cs_sigungu_name + ", cs_zipcode=" + cs_zipcode + ", cs_addr1="
				+ cs_addr1 + ", cs_addr2=" + cs_addr2 + ", cs_map_x=" + cs_map_x + ", cs_map_y=" + cs_map_y
				+ ", cs_tel=" + cs_tel + ", cs_homepage=" + cs_homepage + ", cs_resve_url=" + cs_resve_url
				+ ", cs_resve_cl=" + cs_resve_cl + ", cs_manager=" + cs_manager + ", cs_gnrl_site=" + cs_gnrl_site
				+ ", cs_auto_site=" + cs_auto_site + ", cs_glamp_site=" + cs_glamp_site + ", cs_carav_site="
				+ cs_carav_site + ", cs_indiv_carav_site=" + cs_indiv_carav_site + ", cs_animal_cmg=" + cs_animal_cmg
				+ ", cs_postbl_fclty=" + cs_postbl_fclty + ", cs_sbrs_cl=" + cs_sbrs_cl + ", cs_accom_fee="
				+ cs_accom_fee + ", cs_image=" + cs_image + "]";
	}
	@Override
	public int hashCode() {
		return Objects.hash(cs_accom_fee, cs_addr1, cs_addr2, cs_allar, cs_animal_cmg, cs_auto_site, cs_bizr_no,
				...
				cs_sbrs_cl, cs_sigungu_name, cs_tel, cs_zipcode, rowNum);
	}
	@Override
	public boolean equals(Object obj) {
		...
		return Objects.equals(cs_accom_fee, other.cs_accom_fee) && Objects.equals(cs_addr1, other.cs_addr1)
				...
				&& Objects.equals(cs_zipcode, other.cs_zipcode) && rowNum == other.rowNum;
	}
	public int getCs_no() {
		return cs_no;
	}
