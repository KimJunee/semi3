...
<div class="container-fluid">
    <div class="row" >
        <div class="col-lg-7 col-xl-5 px-4 pb-4 ps-xl-5 pe-xl-5" style="margin-left: auto; margin-top: -20px; width:28%">
        ...
        <div class="col-lg-5 col-xl-7">
            <!-- 카카오 지도-->
            <div id="map" style="position: relative; width:73.4%;height:727px;; margin-top: 35px;"></div>
