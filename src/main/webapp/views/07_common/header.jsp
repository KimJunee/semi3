    ...
    <header class="header">
        ...
        <nav class="navbar navbar-expand-lg fixed-top shadow navbar-light bg-white ">
            <div class="container-fluid ms-n8 ">
                <div class="d-flex align-items-end-1">
                    ...
                    <nav class="navbar bg-white">
                       <div class="container" style="padding-left: 10px;">
                            <form class="d-flex" role="search" action="<%=path%>/campingItem/totalSearch" method="get">
                                <div class="input-label-absolute input-label-absolute-left ms-lg-2 ms-xl-3" style="color: #F7F3E9; width:320px"  >
                ...
                <!-- 헤더 메뉴바 -->
                    ...
                    <div class="collapse navbar-collapse " id="navbarCollapse">
                        <ul class="navbar-nav ms-auto ">
                            ...
                            <li class="nav-item"><a class="nav-link me-4" href="<%=path%>/campingItem/totalSearch" style="font-size:25px;color: rgb(28, 27, 27)">캠핑용품</a>
                            </li>
                                            ...
                                            <div class="row  pb-4 pe-lg-5 ps-lg-6 pt-lg-5">
                                                ...
                                                <div class="col-lg-3">
                                                    ...
                                                    <ul class="megamenu-list list-unstyled">
                                                        ...
                                                        <li class="megamenu-list-item"><a class="megamenu-list-link" href="<%=path %>/mypage/myfavorite">찜한 캠핑장   </a></li>
