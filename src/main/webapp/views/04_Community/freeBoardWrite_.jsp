                    ...
                    <form class="form" id="contact-form" method="get" action="#">
                        <div class="row">
                            <div class="mb-4">
                                ...
                                <textarea class="form-control" rows="2" name="freeBoardTitle" id="freeBoardTitle" placeholder="제목을 작성해 주세요" required="required"></textarea>
                            </div>
                            <div class="mb-4">
                                <label class="form-label fs-5" for="review">문의 내용</label>
                                <textarea class="form-control" rows="10" name="freeBoardContact" id="freeBoardContact" placeholder="내용을 작성해 주세요" required="required"></textarea>
                            </div>
                            <div class="container">
