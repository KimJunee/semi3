...
%>
            ...
            <div class="col-lg-12 ">
                <div class="mx-4 mt-2" style="background-color:#A3D2CA ; height: 80px; font-weight: bolder; font-size: 23px;">
                    <div class="row    ps-lg-5 ">
                        <div class=" col-lg-12   mt-4 ms-4">캠핑장 추천해주세요~</div>
                    </div>
                </div>
            </div>
    </section>
        ...
        <div class="container ">
            <div class="row mx-6 mt-2">
                <div class="col-md-5  " style="font-size: 15px; font-weight:bolder ;">
                    <img src="<%= path%>/resources/img/img_semi/campfire01.png " width="8%"> 사용자닉네임
                </div>
                <div class="col-md-3 ">
                ...
                <div class="mx-2 mt-2" style="background-color:#fff ; height: 80px; font-size: 18px;">
                    <div class="row    px-sm-6 ">
                        <div class=" col-lg-12   mt-4 ms-4 me-4">
                            수원에서 2시간정도내 거리에 있는 계곡이 있는 캠핑장 추천 부탁드립니다.강원도 경기도 충청도 작은 계곡 말고 성인들이 물놀이 할수있는 깊은물이 있는곳으로요. 답변주시면 감사하겠습니다.수원에서 2시간정도내 거리에 있는 계곡이 있는 캠핑장 추천 부탁드립니다.강원도 경기도 충청도 작은 계곡 말고 성인들이 물놀이 할수있는 깊은물이 있는곳으로요. 답변주시면 감사하겠습니다.
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="pt-0 pb-3 ps-7 ">
        <div class="container">
            <div class="col-lg-12 ">
                <div class=" fs-4 mb-3" style="font-weight:bolder; color: #F05945;"> 댓글 수 1 </div>
            </div>
        </div>
    </section>
    <!-- 댓글 작성하기 -->
        ...
        <div class="container ">
            <div class="row my-3">
                <div class="col-md-3" style="font-size: 20px; font-weight:bolder ; text-align: center;">
                    <img class=" avatar avatar-sm   " src="<%= path%>/resources/img/img_semi/campfire01.png" alt=""> 캠핑사나이
                </div>
                <div class="col-md-9 ">
                    <form action="#">
                        <div class="row pe-6">
                            ...
                            <div class="col-lg-11 d-flex  form-group" style="height: 60px; width:1200px;">
                                <input type="text" class="form-control" style="font-size: 15px; color: rgb(203, 203, 203);" placeholder="댓글을 입력하세요">
                                <!-- 검색버튼 -->
                                <div class="col-lg-1 d-grid ps-4" style="height: 60px;">
                                    <button class=" btn btn-primaryCuntom rounded-top" style="font-size: 20px; width: 100px; ">등록</button>
                                </div>
                            </div>
                        </div>
                    </form>
    ...
    <section class="pt-0 pb-3 p-print-0">
        <div class="container ">
            ...
            <div class="row my-3 pb-4">
                <div class="col-md-3" style="font-size: 20px; font-weight:bolder ; text-align: center;">
                    <img class=" avatar avatar-sm   " src="<%= path%>/resources/img/img_semi/campfire01.png" alt=""> 자연 여행자
                </div>
                <div class="col-md-9 ">
                    <form action="#">
                        <div class="row pe-6">
                            <div class="col-lg-11 d-flex form-group" style="color:#232222; height: 60px; width:1200px; ">
                                가평 명지계곡 추천합니다. 가평북면 명지산 방향으로 달리다보면 좌측으로 생태전시관 주차장,오른쪽은 유명한 인천하우스 입니다. 작년에 경기도 계곡정비사업으로 여기도 모두 정비되어 이젠 계곡을 사용해도 됩니다. 인천하우스 위로부터 물가로 어디든 내려가면 됩니다.[주차단속만 조심하세요]
                            </div>
                        </div>
                    </form>
                </div>
